...
function initData(response){
    ...
    '<div class="card-wrap">\n'+
        '<div class="box-fixed">\n'+
            '<div class="card-price">\n'+
                '<p class="left">'+ response.greenHouse.price +'<span>元</span></p>\n'+
    ...
    console.log(response.communityList[0].key_sale);
    if(response.communityList[0].key_sale == ""){
        response.communityList[0].key_sale = "暂无"
    }
    if(response.communityList[0].traffic == ""){
        response.communityList[0].traffic = "暂无"
    }
    if(response.communityList[0].surrouding == ""){
        response.communityList[0].surrouding = "暂无"
    }
    if(response.communityList[0].introduce == ""){
        response.communityList[0].introduce = "暂无"
    }
    var housWrap = "";
    housWrap +=
 ...
 */
function cardFix2() {
    var fheight = $('.xiaoqu-info').height() + 20; // 获取底部及底部上方边距的总高度
